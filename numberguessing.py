...
import time
number=random.randint(1, 2032) #pick the number between 1 and 2032

def intro():
    print("May I ask you for your name?")
    name=input() #asks for the name
    print(name +", we are going to play a game. I am thinking of a number between 1 and 2032")
    time.sleep(.5)
...
def pick():
    ...
    while guessesTaken < 6: #if the number of guesses is less than 6
        ...
        try: #check if a number was entered
            ...
            if guess<=2032 and guess>=1: #if they are in range
            ...
            if guess>2032 or guess<1: #if they aren't in the range
                print("Silly Goose! That number isn't in the range!")
                time.sleep(.25)
                print("Please enter a number between 1 and 2032")
